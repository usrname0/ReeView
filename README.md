...
The view tab will show the image or video in as large a format as possible.  There will be next/previous buttons.  There will be a bank of buttons to move files to the preselected destinations on the side.
I may later add some ability to read and/or modify metadata but that can wait for a later stage.
